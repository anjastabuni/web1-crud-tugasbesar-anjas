          ...
          <div class="col-8 mx-auto">
            ...
            <div class="card text-center">
              ...
              <div class="card-header pt-5 bg-primary">
                <h1 class="text-light"> <i class="fa-solid fa-circle-plus"></i> Tambah Data Hewan</h1>
                <p class="text-dark py-4">Silakan masukan data </p>
              </div>
              <!-- CARD HEADER END -->
              ...
              <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="nama" id="nama" class="form-control form-control-lg p-4" placeholder="Masukan nama hewan... "  required>
                    </div>
                    <!-- form group end -->
                    ...
                    <div class="form-group mb-3">
                        ...
                        <select id="jenis-kelamin" name="gender" class="form-select form-select-lg py-4 mb-3">
                            <option selected>Pilih</option>
                            <option value="l">Jantang</option>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="asal" id="asal" class="form-control form-control-lg p-4"  required>
                    </div>
                    <!-- form group end -->
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="distrik" id="distrik" class="form-control form-control-lg p-4"  required>
                    </div>
                    <!-- form group end -->

                    <!-- form group start -->
                    <div class="form-group mb-3">
                        <label for="gambar" class="form-label fw-bolder text-muted">
                        <i class="fa-solid fa-id-card-clip me-1"></i> Gambar</label>
                    ...
                    <!-- form group end -->
                     ...
                     <!-- form group start -->
                  <div class="form-group mb-3">
                    <button type="submit" name="submit" class="btn btn-primary text-light p-4 w-100 fw-bolder">Kirim </button>
                  </div>
                  <!-- form group end -->
                </form>
              </div>
